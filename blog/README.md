...
주소는 `https://agd.snack-test.com/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://agd.snack-test.com/blog/agoda-coupon/ |
...
- 포인트 색: **#1B79E5** (azure) — `blog.css` 맨 위 `--blog-point`
